...
sector: defence
created: 2026-05-20
tags: [foothold-maintainer, defence, user-centred-design, consultancy]
---

# MilUX

> **Foothold maintainer.** MilUX is the consultancy that built Foothold and the network entry point for everyone who installs it. Public-facing reference profile.
...
MilUX is a defence-focused user-centred design consultancy. It combines defence sector understanding, user-centred design, product and service thinking, delivery pragmatism, and training into a single practice. The focus is on bringing the human and operational reality of defence into the heart of capability development, procurement, and adoption.

MilUX works across leadership, delivery, marketing, service development, training, community building, and defence-facing engagement, rather than staying inside a narrow functional lane. Clients are typically defence-sector SMEs, MOD bodies, and primes engaged in capability work where the end user's experience materially shapes the outcome.

## Capabilities and services

- **User-centred design applied to defence procurement and capability development.**
- **Kanban-based delivery for distributed teams.** Kanban University Accredited Kanban Trainer (AKT) on staff.
- **AI-assisted second-brain design and adoption.** Cowork plus Obsidian as the working substrate. Foothold is one of the outputs of this practice.
- **Defence-sector network access** across the UK regional defence and security clusters.
...
MilUX built Foothold to short-circuit the months that defence-sector founders typically lose to figuring out the procurement landscape and building a working knowledge system from scratch. The pack's structure, conventions, and skills come from MilUX's own working vault.
...
The vault you're holding is the memory layer. It only becomes a working operating model once Claude can act on what's in it and reach the rest of the tools MilUX runs on. Here's how that's wired up. None of this is required to use Foothold. It's offered as one worked example of where this can go, and roughly what it costs at each step.
...
A skill is a vault-stored instruction that turns a recurring job into a single conversational ask. These are the ones that earn their keep most often:
...
- **Event page.** New event in the calendar triggers a vault page with the right structure, Chatham House check, and links into Businessmap for any actions captured on the day.
